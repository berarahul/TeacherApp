...
class DepartmentController extends GetxController {
  ...
  // void onInit() {
  //   super.onInit();
  //   fetchDepartments(); // Initial fetch when the controller is initialized
  // }
  ...
  Future<void> fetchDepartments() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Clear previous departments and update with new data
        departments.clear();
        departments.addAll(departmentModels);

        // Select the first department by default if departments are fetched
  ...
  // Method to clear departments list
